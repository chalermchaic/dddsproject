...
**เวอร์ชัน 1.2.3** — ดูเลขล่าสุดที่ไฟล์ [`VERSION`](VERSION)

- `1.2.3` — ปรับปรุง UI แดชบอร์ด Classification Report เป็นตารางสถิติแบบคลีน และปรับปรุงการเข้ารหัส UTF-8 บน Windows Console
...
## ✅ ครอบคลุมกิจกรรม DFD ครบ 14 (v1.2.3)
