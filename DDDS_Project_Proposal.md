...
### 2.1 โมดูลการทำงานตามกระบวนการหลัก (5 Core Processes)
1. **Process 1.0 (Marketing Management):** จัดการแคมเปญการตลาด โปรโมชัน และการบันทึกข้อมูลผู้สนใจ (Leads)
2. **Process 2.0 (Sales & Lead Follow-up):** บันทึกกิจกรรมการติดตามผู้สนใจ (Lead Activity) และการเปลี่ยนสถานะการขาย
3. **Process 3.0 (Order & Billing Management):** ออกใบเสนอราคา คำสั่งซื้อ และบันทึกหลักฐานการชำระเงิน
4. **Process 4.0 (Customer Profile & Onboarding):** จัดเก็บประวัติลูกค้าอย่างเป็นทางการหลังปิดการขาย
5. **Process 5.0 (Customer Support & Ticket):** จัดการเคสแจ้งปัญหา บันทึกการแก้ไข และติดตามสถานะบริการ
...
* **เป้าหมาย:** ตรวจจับสัญญาณเตือนก่อนที่ลูกค้าจะเลิกใช้บริการ โดยประเมินจากประวัติปัญหาและคุณภาพงานบริการ
* **ตารางที่ใช้:** `CUSTOMER`, `TICKET`, `TICKET_MESSAGE`
* **ตัวแปรในการวิเคราะห์ (Health Indicators):**
  ...
  * `COUNT(TICKET_MESSAGE.Message_ID)` — จำนวนข้อความร้องเรียน/โต้ตอบในเคส
* **ผลลัพธ์:** คำนวณเป็น **Customer Health Score (0–100)** แจ้งเตือนระดับความเสี่ยง (เขียว/เหลือง/แดง)
