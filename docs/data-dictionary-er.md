...
| `Sale_Status` | VARCHAR(20) | - | NO | สถานะ: 'ออกใบเสนอราคาแล้ว' → 'รอตรวจสอบคำสั่งซื้อ' → 'รอการตรวจสอบชำระเงิน' → 'ปิดการขายสำเร็จ' |
| `Order_Confirmed_At` | TIMESTAMP | - | YES | 3.1: วันเวลาที่ผู้สนใจยืนยันคำสั่งซื้อ |
| `Payment_Slip` | VARCHAR(100) | - | YES | 3.2: ชื่อไฟล์สลิปที่ลูกค้าอัปโหลด (`uploads/`) |
| `Invoice_No` | VARCHAR(20) | - | YES | หมายเลขใบแจ้งหนี้ / ใบเสร็จรับเงิน |
| `Payment_Ref` | VARCHAR(100) | - | YES | หลักฐานอ้างอิงการโอนเงิน |
...
| `Service_Rating` | INT (1–5) | - | YES | 4.3: คะแนนประเมินผลบริการจากลูกค้า |
| `Service_Feedback` | TEXT | - | YES | 4.3: ความเห็นเพิ่มเติมจากลูกค้า |
